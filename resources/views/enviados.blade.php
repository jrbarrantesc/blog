...
<head>
  ...
  <link rel="stylesheet" type="\text/css" href="\css/login.css">
</head>
<header>
  <div class="container">
    <h1><b><i> Bandeja de Enviados</i></b></h1>
    <br>
  </div>
  <body>
     </header>
    ...
    <div class ="container col-xs-8">
     ...
     <tbody >
      ...
      <tr>
        ...
        <td>{{$mail->mensaje}}</td>
        <td>{{$mail->fecha}}</td>
        <td><a class="btn btn-info glyphicon glyphicon-edit " href="{{URL::route('mail.edit',$mail->id)}}" type="button"></a></td>
        <td>
